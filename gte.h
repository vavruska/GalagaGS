...
extern pascal void GTECopyPicToBG1(Word width, Word height, Word stride, Pointer picPtr, Word flags) inline(0x17A0, tool_dispatcher);
...
/* BG Constants */
#define GTE_COPY_PIC_NORMAL        0x0000
#define GTE_COPY_PIC_SCANLINE      0x0001

/* GTE Sprint Stamp Storage Parameters */
#define GTE_VBUFF_STRIDE_BYTES     ((word)(12 * 4))                    /* Each line has 4 slots of 16 pixels + 8 buffer pixels */
...
#define GTE_VBUFF_SLOT_COUNT       (56)                                /* Have space for this many stamps */
#define GTE_MAX_SPRITE             (128)
